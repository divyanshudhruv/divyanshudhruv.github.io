...
export default function WeatherCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 justify-between rounded-xl border border-border/60 bg-background/50 px-2.5 py-8 text-[13px] font-medium tabular-nums leading-none backdrop-blur-sm">
