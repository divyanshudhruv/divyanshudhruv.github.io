...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      // Generate theme-appropriate color
      let lineColor = configRef.current.lineColor;
      if (isDarkMode && lineColor === '#ddd') {
        // Generate darker shade for dark mode
        lineColor = '#ddd'; // Darker version of #ddd
      } else if (!isDarkMode && lineColor === '#ddd') {
        lineColor = '#ddd'; // Keep original for light mode
      }
