...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "mb-0", // Remove extra bottom margin
      className
    )}
    {...props}
  >
    ...
    <div className="absolute inset-0 rounded-[16px]">
      <div
        className={cn(
          ...
          "shadow-[0px_0px_0px_1px_rgba(0,0,0,.07),0px_0px_0px_3px_#fff,0px_0px_0px_4px_rgba(0,0,0,.2)]",
          "dark:shadow-[0px_0px_0px_1px_rgba(0,0,0,.07),0px_0px_0px_3px_rgba(100,100,100,0.3),0px_0px_0px_4px_rgba(0,0,0,.2)]"
        )}
      />
      <div
        className={cn(
